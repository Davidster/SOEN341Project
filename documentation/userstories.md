...
As a teacher assistant, I want to be able to track the contribution of each team member,
 in order to evaluate every participant fairly. 
 	...
 	* To do: (William; 2 weeks) Add specific authorization for the TA to access any group chats using PHP and MySQL.
...
allowing me to view relevant information and interact with the team.
	...
	* To do: 
		(William, someone; 3 weeks) Add links to have access to each group page.
		(William, someone; 3 weeks) Display relevant information about each group in their page (Names, IDs, emails, accounts..)
